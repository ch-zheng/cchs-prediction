...
training = False # Training or evaluation
...
# Load data
if training:
    samples = torch.from_numpy(np.load('data/training/samples.npy'))
    labels = torch.from_numpy(np.load('data/training/labels.npy'))
else:
    samples = torch.from_numpy(np.load('data/test/samples.npy'))
    labels = torch.from_numpy(np.load('data/test/labels.npy'))
